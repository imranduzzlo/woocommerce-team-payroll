							...
							<div class="profile-achievement-badge profile-achievement-badge-<?php echo esc_attr( $highest_tier ); ?>">
								<svg class="badge-icon" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
									<defs>
										...
										<radialGradient id="goldGradientAcc" cx="35%" cy="35%">
										...
										<linearGradient id="goldShineAcc" x1="0%" y1="0%" x2="100%" y2="100%">
										...
										<radialGradient id="silverGradientAcc" cx="35%" cy="35%">
										...
										<linearGradient id="silverShineAcc" x1="0%" y1="0%" x2="100%" y2="100%">
										...
										<radialGradient id="bronzeGradientAcc" cx="35%" cy="35%">
										...
										<linearGradient id="bronzeShineAcc" x1="0%" y1="0%" x2="100%" y2="100%">
										...
										<filter id="coinShadowAcc" x="-50%" y="-50%" width="200%" height="200%">
											<feDropShadow dx="2" dy="3" stdDeviation="2" flood-opacity="0.4"/>
										</filter>
									</defs>
									
									<!-- Outer Ring (3D Edge) -->
									<circle cx="50" cy="50" r="46" fill="url(#<?php echo esc_attr( $highest_tier ); ?>GradientAcc)" stroke="#000000" stroke-width="0.5" opacity="0.3"/>
									
									<!-- Main Coin Circle with 3D Gradient -->
									<circle cx="50" cy="50" r="45" fill="url(#<?php echo esc_attr( $highest_tier ); ?>GradientAcc)" stroke="#000000" stroke-width="1" filter="url(#coinShadowAcc)"/>
									
									<!-- Shine/Highlight for 3D Effect -->
									<ellipse cx="40" cy="35" rx="20" ry="18" fill="url(#<?php echo esc_attr( $highest_tier ); ?>ShineAcc)" opacity="0.7"/>
									...
									?>
									<circle cx="82" cy="82" r="14" fill="<?php echo esc_attr( $rank_circle_color ); ?>" stroke="#FFFFFF" stroke-width="2" filter="url(#coinShadowAcc)"/>
						...
						<?php else : ?>
							...
							<div class="profile-achievement-badge profile-achievement-badge-locked">
								<svg class="badge-icon" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
									<defs>
										<!-- Muted Gray Gradient -->
										<radialGradient id="lockedGradientAcc" cx="35%" cy="35%">
										...
										<filter id="lockedShadowAcc" x="-50%" y="-50%" width="200%" height="200%">
											<feDropShadow dx="2" dy="3" stdDeviation="2" flood-opacity="0.3"/>
										</filter>
									</defs>
									
									<!-- Main Coin Circle -->
									<circle cx="50" cy="50" r="45" fill="url(#lockedGradientAcc)" stroke="#000000" stroke-width="1" opacity="0.5" filter="url(#lockedShadowAcc)"/>
									...
									<circle cx="82" cy="82" r="14" fill="#9E9E9E" stroke="#FFFFFF" stroke-width="2" opacity="0.5" filter="url(#lockedShadowAcc)"/>
