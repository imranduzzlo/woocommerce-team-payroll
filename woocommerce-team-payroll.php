 ...
 * Update URI: https://github.com/imranduzzlo/woocommerce-team-payroll
 * WC requires at least: 5.0
 * WC tested up to: 10.7.0
 * Requires Plugins: woocommerce
 * Text Domain: wc-team-payroll
 * Domain Path: /languages
 * GitHub Plugin URI: imranduzzlo/woocommerce-team-payroll
 * GitHub Branch: main
 */
...
define( 'WC_TEAM_PAYROLL_VERSION', '1.0.31' );
...
add_action( 'plugins_loaded', function() {
	...
	require_once WC_TEAM_PAYROLL_PATH . 'includes/class-location-formatter.php';
	...
	require_once WC_TEAM_PAYROLL_PATH . 'includes/class-leaderboard-engine.php';
	require_once WC_TEAM_PAYROLL_PATH . 'includes/class-order-editor.php';
	require_once WC_TEAM_PAYROLL_PATH . 'includes/class-frontend-editor.php';
	...
	// Initialize Order Editor System
	WC_Team_Payroll_Order_Editor::init();

	// Initialize Frontend Editor System (Price & Shipping)
	WC_Team_Payroll_Frontend_Editor::init();

	// Hook to recalculate commission when order is edited
	add_action( 'wc_team_payroll_order_edited', function( $order_id ) {
		$core_engine = new WC_Team_Payroll_Core_Engine();
		$core_engine->calculate_order_commission( $order_id );
	} );
	...
	add_action( 'wp_ajax_wc_tp_check_github_update', function() {
		...
		$response = wp_remote_get(
			'https://api.github.com/repos/imranduzzlo/woocommerce-team-payroll/releases/latest',
			array(
				'timeout'   => 10,
				'sslverify' => true,
				'headers'   => array(
